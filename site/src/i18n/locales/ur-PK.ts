...
export default {
  ...
  useCases: { ...enUS.useCases, title: "کیسز 🎯 استعمال کریں", case1: "اپنے فون کو کھولے بغیر اسکرین شاٹس سے فوری طور پر QR کوڈز کا تجزیہ کریں", case2: "QR کوڈ کی تصاویر محفوظ کرنے کے بعد فوری طور پر مواد نکالیں", case3: "ترقی کے دوران پیدا کردہ QR کوڈز کی فوری طور پر توثیق کریں", case4: "دستاویز یا ویب صفحے کے اسکرین شاٹس سے QR کوڈ کی معلومات نکالیں" },
  download: { ...enUS.download, title: "ابھی ڈاؤنلوڈ کریں", text: "اپنے پلیٹ فارم کے لیے تازہ ترین ورژن ڈاؤن لوڈ کرنے کے لیے GitHub ریلیزز کے صفحے پر جائیں", latestVersion: "تازہ ترین ورژن ڈاؤن لوڈ کریں؟" },
  footer: { ...enUS.footer, privacyPolicy: "رازداری کی پالیسی", termsOfService: "سروس کی شرائط", refundPolicy: "ریفنڈ کی پالیسی", copyright: "© 2026 -اب کلپ کیو آر ۔ کے ساتھ بنایا گیا ❤️" },
  meta: { ...enUS.meta, title: "ClipQR - فوری QR کوڈ اسکینر", description: "ClipQR - فوری QR کوڈ اسکینر، کراس پلیٹ فارم ڈیسک ٹاپ ایپ، فوری طور پر کلپ بورڈ اور مقامی تصاویر سے QR کوڈ کا مواد پڑھیں" },
}
